...
uint256 hashGenesisBlock("0x90d4be97853ae7ff803c17e6ba690f7eba8a24e314861426433da82657a26fba");
...
static const int64 nTargetSpacing =  60; // VRXcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
	  ...
	  hashGenesisBlock = uint256("0x7f18aa040cf4ead545610408208275e93dbc615a5612f4952cb6dd68704dd9fa");    
}
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "VRX Cryptocurrency";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp,
        ...
        block.nVersion = 1;
        block.nTime    = 1539468120;;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 345769;

        if (fTestNet)
        {
            block.nTime    = 1539468120;//13177986461539468120;
            block.nNonce   = 345769;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x23cbc4b4b7d0ece8e9c0af574baa0a7bd88071bddf3c3a00643b60543d43bdb7"));
